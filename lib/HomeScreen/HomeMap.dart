...
//            );
  ...
  Widget build(BuildContext context) {
    setState(() {
      rideStutus = prefs.getString('ride_status').toString();
    });
...
//                          ))
                ...
                mobilePreferences: const MobileMapPreferences(
                    padding: EdgeInsets.only(top: 80.0, right: 10, bottom: 100),
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      new SizedBox(
                                        width:
                                            SizeConfig.safeBlockHorizontal * 58,
                                        child: Text(
  ...
  Future<void> getDataLanguage() async {
